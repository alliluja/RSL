...
class stringEx extends String {
    ...
    isPresent(str) { return this.indexOf(str) >= 0; }
}
exports.DEFAULT_WHITESPACES = new stringEx(" \n\r\t");
exports.DIGITS = "0123456789";
exports.STOP_CHARS = " .,()\:;=<>![]" + exports.DEFAULT_WHITESPACES;
exports.tokensWithEnd = new Array("class", "macro", "if", "for", "while");
/**
 * Для кортежей.
 */
var t;
(function (t) {
    t[t["boolVal"] = 0] = "boolVal";
    t[t["numIndex"] = 1] = "numIndex"; //первый элемент  - число
